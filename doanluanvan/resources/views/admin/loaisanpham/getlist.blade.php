    ...
    <div class="col-xl-6 col-lg-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{route('themLoaiSanPham')}}" class="btn btn-rounded btn-info"><span class="btn-icon-left text-info"><i class="fa fa-plus color-info"></i>
                    </span>Add</a>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="example2" class="display" style="width:100%">
                        ...
                        <tbody>
                            @foreach($loaisp as $val)
                            <tr>
                                <td >{{$val->id}}</td>
                                <td >{{$val->loaisp_ten}}</td>
                                <td>
                                    <div class="d-flex">
