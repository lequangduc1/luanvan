            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="example2" class="display" style="width:100%">
                        ...
                        <tbody>
                            @foreach($tuyendung as $val)
                            <tr>
                                <td >{{$val->id}}</td>
                                <td >{{$val->tuyendung_tieu_de}}</td>
                                <td >{{$val->tuyendung_anh}}</td>
                                <td >{{$val->tuyendung_mo_ta}}</td>
                                <td >{{$val->tuyendung_lien_he}}</td>
                                <td >{{$val->tuyendung_thoi_gian}}</td>
                                <td >{{$val->tuyendung_tinh_trang}}</td>
                                <td>
                                    <div class="d-flex">
