    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{route('themslider')}}" class="btn btn-rounded btn-info"><span class="btn-icon-left text-info"><i class="fa fa-plus color-info"></i>
                    </span>Add</a>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="example2" class="display" style="width:100%">
                        ...
                        <tbody>
                            @foreach($slidershow as $val)
                            <tr>
                                <td >{{$val->id}}</td>
                                <td >{{$val->slider_hinh_anh}}</td>
                                <td>
                                    <div class="d-flex">
