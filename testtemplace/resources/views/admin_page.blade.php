...
<head>
    ...
    <link href="{{asset('public/frontend/images/favicon.png')}}" rel="icon" type="image/png" sizes="16x16">
    <link href="{{asset('public/frontend/vendor/jqvmap/css/jqvmap.min.css')}}" rel="stylesheet">
    <link href="{{asset('public/frontend/vendor/chartist/css/chartist.min.css')}}" rel="stylesheet">
    <link href="{{asset('public/frontend/bootstrap-select/dist/css/bootstrap-select.min.css')}}" rel="stylesheet">
    ...
    <!-- Datatable -->
    <link href="{{asset('public/frontend/vendor/datatables/css/jquery.dataTables.min.css')}}" rel="stylesheet">
    <!-- Custom Stylesheet -->
    <link href="{{asset('public/frontend/vendor/bootstrap-select/dist/css/bootstrap-select.min.css')}}" rel="stylesheet">
...
<body>
    ...
    ***********************************-->
    ...
    <script src="{{asset('public/frontend/vendor/global/global.min.js')}}"></script>
    <script src="{{asset('public/frontend/vendor/bootstrap-select/dist/js/bootstrap-select.min.js')}}"></script>
    <script src="{{asset('public/frontend/vendor/chart.js/Chart.bundle.min.js')}}"></script>
    <script src="{{asset('public/frontend/js/custom.min.js')}}"></script>
    <script src="{{asset('public/frontend/js/deznav-init.js')}}"></script>
    <!-- Apex Chart -->
    <script src="{{asset('public/frontend/vendor/apexchart/apexchart.js')}}"></script>
    <!-- Vectormap -->
    <!-- Chart piety plugin files -->
    <script src="{{asset('public/frontend/vendor/peity/jquery.peity.min.js')}}"></script>
    <!-- Chartist -->
    <script src="{{asset('public/frontend/vendor/chartist/js/chartist.min.js')}}"></script>
    <!-- Dashboard 1 -->
    <script src="{{asset('public/frontend/js/dashboard/dashboard-2.js')}}"></script>
    <!-- Svganimation scripts -->
    <script src="{{asset('public/frontend/vendor/svganimation/vivus.min.js')}}"></script>
    <script src="{{asset('public/frontend/vendor/svganimation/svg.animation.js')}}"></script>
    <script type=”text/javascript” src=”http://code.jquery.com/jquery-2.0.3.min.js”></script>
    <!-- <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script> -->

    <!-- Datatable -->
    <script src="{{asset('public/frontend/vendor/datatables/js/jquery.dataTables.min.js')}}"></script>
    <script src="{{asset('public/frontend/js/plugins-init/datatables.init.js')}}"></script>

    <script src="{{asset('public/frontend/js/main111.js')}}"></script>
